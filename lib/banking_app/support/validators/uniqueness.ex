defmodule BankingApp.Support.Validators.Uniqueness do
  use Vex.Validator
  ...
  def validate(value, options) when is_list(options) do
    unless_skipping(value, options) do
      ...
      case call_prerequisite(validator, value) do
  ...
  defp call_prerequisite(nil, _), do: :ok
  defp call_prerequisite(validator, value) do
